"""
Django settings for interdb project.
...
SECRET_KEY = 'my)m32h4)v!^@-(gd%36)ew==f5zto9!54u65^rwi%(&5%_e7k'
...
WSGI_APPLICATION = 'interdb.wsgi.application'
